...
export default async function PlanosPage() {
  ...
  const [plans, invoiceByPlan, apptByPlan] = await Promise.all([
  ...
  return (
    <>
      <PageHeader eyebrow="Gestão" title="Planos de Saúde" description={`${plans.length} planos · ${formatMZN(totalPending)} por receber de seguradoras`} />
